...
var sample1 =[[0.354,0.35,66,38,1.59,0.28,0.57,"stiff",0.795],
   			[0.268,0.26,64,42,1.1,0.14,0.28,"Medium",0.55],
			[0.429,0.42,64,38,1.76,0.28,0.57,"stiff",0.88]];
			// console.log(sample1[i])
// console.log(sample1[i])

var finalData=[[1.59,0.795, 42, 0.354],
			   [1.10,0.55, 38, 0.268],
			   [1.76,0.88, 38, 0.429]];
...
let layout1a = {
	...
	xaxis: {
	range:[0,1.7],
	title:'Unconfined Compressive Stress, σ (kg/cm<sup>2</sup>)',
    fixedrange: true
	},
	yaxis: {
		range: [ 0,0.9],
...
document.getElementById("p17-5").innerHTML="The Shear stress of the given soil  = <span style='border-bottom-style:double'> "+sample1[i][8] + "kg/cm<sup>2</sup>";

document.getElementById("17-6b").innerHTML="The Unconfined Compressive Strength of the given soil is "+sample1[i][4] + "kg/cm<sup>2</sup> and the Shear stress is " + +sample1[i][8] +  "kg/cm<sup>2</sup>." + "The value of cohesive strength of soil obtained from the experiment is "+sample1[i][1] + "kg/cm<sup>2</sup>. Hence the " + "of soil is " + sample1[i][7] + " clay whose cohesive strength ranges from " + sample1[i][5] +  " to "  + sample1[i][6] +  "kg/cm<sup>2</sup>.";
// document.getElementById("17-6").innerHTML=
// document.getElementById("17-6a").innerHTML=
...
function Observation1(){
	...
	let oInput2 = Number(document.getElementById("sh1").value);
	// console.log(oInput1);
	let resultVisible = false;
	if(!oInput1 && !oInput2 )
		{
		...
		else
		{
			...
			if(oInput2 == finalData[i][1]){
				setEvaluateColor("rightAns114", true)
				// console.log('shear')
				resultVisible = false;

			} else {
				setEvaluateColor("rightAns114", false)
				// console.log('shear')
				resultVisible = true;
			}	
			}
...
function evaluateArea5() {
	let area = finalData[i][3];
	document.getElementById("sh1").value = finalData[i][1]
	document.getElementById("C1").value = area;
	document.getElementById("rightAns14").style.visibility = "hidden";
	document.getElementById("rightAns114").style.visibility = "hidden";
	document.getElementById("Result14").style.visibility = "hidden"
	document.getElementById("14-1").style.visibility = "hidden"
	document.getElementById('nextButton').style.visibility="visible";
...
function Observation7()
{
	...
	else
	{
				...
				if(resultVisible){
					...
					document.getElementById('p17-3').style.visibility="visible"
					document.getElementById('p17-4').style.visibility="visible"
					document.getElementById('p17-5').style.visibility="visible"
...
function showcohesion(){
	document.getElementById('cohesiontext').style.visibility="visible"
}

function outcohesion(){
	document.getElementById('cohesiontext').style.visibility="hidden"
}
